...
| 3 | MicroSims | 59 | Recommended | Interactive simulations in docs/sims/ |
...
| 9 | Words | 156,586 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 45 | 45 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 1 | LaTeX expressions (inline and display) |
| Total Words | 156,586 | 137,799 | Words in markdown files |
| Links | 385 | 74 | Hyperlinks in markdown format |
| Equivalent Pages | 667 | 591 | Estimated pages (250 words/page + visuals) |
